...
source_path: .claude/commands/4_implement_plan.md
source_blob_url: https://github.com/brilliantconsultingdev/claude-research-plan-implement/blob/main/.claude/commands/4_implement_plan.md
---
